...
- **Order Management**: 
  ...
  - Shipping information with insurance
  - Returns and exchanges handling for valuable items
- **Product Guide**: 
...
├── shipping-info.html # Secure shipping details
├── size-guide.html    # Ring and bracelet sizing guide
├── returns-exchanges.html # Returns policy
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Arathi0727/House_of_Chic.git
   ```
